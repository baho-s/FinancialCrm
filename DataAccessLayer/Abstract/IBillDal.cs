...
namespace DataAccessLayer.Abstract
{
    public interface IBillDal:IGenericDal<Bill>
    {
        ...
        List<BillDashboardDto> GetBillTitleAmountListDto();
        List<BillListDto> GetActiveBillsDto();

        List<BillListDto> GetDeletedBillsDto();

        bool BillExists(string title, string period, decimal amount);
